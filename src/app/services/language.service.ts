...
export class LanguageService {
  ...
  private translations: Record<Language, Record<string, string>> = {
    en: {
      ...
      review1Text: '"XLG Solutions transformed our financial processes. Their team is professional, knowledgeable, and incredibly supportive."',
      review1Author: 'Jane Doe',
      review1Role: 'CEO, Tech Startup',
      review2Text: '"The tax planning advice we received was invaluable. It saved us a significant amount and gave us peace of mind."',
      review2Author: 'John Smith',
      review2Role: 'Small Business Owner',
      review3Text: '"Navigating health insurance was a breeze with their help. Highly recommended for their expertise and friendly service."',
    ...
    es: {
      ...
      review1Text: '"XLG Solutions transformó nuestros procesos financieros. Su equipo es profesional, experto y nos brinda un gran apoyo."',
      review1Author: 'Jane Doe',
      review1Role: 'Directora Ejecutiva, Startup Tecnológica',
      review2Text: '"El asesoramiento sobre planificación fiscal que recibimos fue invaluable. Nos ahorró una cantidad significativa y nos dio tranquilidad."',
      review2Author: 'John Smith',
      review2Role: 'Propietario de Pequeña Empresa',
      review3Text: '"Navegar por el seguro de salud fue muy fácil con su ayuda. Muy recomendados por su experiencia y servicio amable."',
      review3Author: 'Maria Garcia',
